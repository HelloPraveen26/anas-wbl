...
const MockFavicon = {
  src: "https://placehold.co/40x40/0d6efd/FFFFFF?text=Z",
  alt: "ZenXai Favicon",
};
...
export default function SignUp() {
  ...
  const handleGoogleSignUp = () => {
    setErrors({
      general:
        "Google sign-up is not implemented yet. Please use email/password.",
    });
  };
  // -------------------------------------------------------------------------
  ...
  return (
    ...
    <div className="min-h-screen bg-white flex overflow-hidden relative">
      ...
      {/* ========================================================= */}
      <div
        className="w-full lg:w-1/2 text-white relative flex flex-col items-center justify-center p-8 lg:p-12 -pt-12 rounded-2xl m-4 lg:m-8"
        style={{
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center">
              <span className="px-4 text-sm text-gray-400 bg-gray-150 font-medium">
                OR USE YOUR EMAIL
              </span>
            </div>
          </div>
