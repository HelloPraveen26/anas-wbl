...
//               <CardContent className="p-6">
//                 <div className="space-y-4">
//                   <h3 className="text-lg font-semibold text-gray-900">Calls volume</h3>
...
//           {/* Second Row - User Sentiments, Call Status, and Task Status */}
//           <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
//             {/* User Sentiments */}
//             <Card className="bg-white shadow-lg">
//               <CardContent className="p-6">
//                 <CustomPieChart
//                   data={mockData.sentiments}
...
//                   {mockData.phoneNumbers.map((item, index) => (
//                     <div key={index} className="flex items-center justify-between">
//                       <span className="text-sm text-gray-600">{item.name}</span>
//                       <span className="text-sm font-medium text-gray-900">{item.calls}</span>
//                     </div>
//                   ))}
//                 </div>
//               </CardContent>
...
//               <CardContent>
//                 <div className="space-y-3">
//                   {mockData.aiAgents.map((item, index) => (
//                     <div key={index} className="flex items-center justify-between">
//                       <div className="flex items-center space-x-2">
...
//               <CardContent>
//                 <div className="space-y-3">
//                   {mockData.widgets.map((item, index) => (
//                     <div key={index} className="flex items-center justify-between">
//                       <span className="text-sm text-gray-600">{item.name}</span>
//                       <span className="text-sm font-medium text-gray-900">{item.calls}</span>
//                     </div>
...
//               <CardContent>
//                 <div className="space-y-3">
//                   {mockData.ratings.map((item, index) => (
//                     <div key={index} className="flex items-center justify-between">
...
//             <Card className="bg-white shadow-lg">
//               <CardHeader>
//                 <CardTitle className="text-lg">End Call Reasons</CardTitle>
//               </CardHeader>
//               <CardContent>
//                 <div className="space-y-3">
//                   {mockData.endCallReasons.map((item, index) => (
//                     <div key={index} className="flex items-center justify-between">
//                       <span className="text-sm text-gray-600 flex-1 mr-2">{item.reason}</span>
//                       <span className="text-sm font-medium text-gray-900">{item.calls}</span>
//                     </div>
//                   ))}
//                 </div>
...
//               <CardContent>
//                 <div className="space-y-3">
//                   {mockData.actions.map((item, index) => (
//                     <div key={index} className="flex items-center justify-between">
//                       <div className="flex items-center space-x-2">
//                         {item.name.includes('Sms') && <MessageSquare className="w-4 h-4 text-gray-500" />}
//                         {item.name.includes('Email') && <Mail className="w-4 h-4 text-gray-500" />}
//                         {item.name.includes('Call') && <Phone className="w-4 h-4 text-gray-500" />}
//                         <span className="text-sm text-gray-600">{item.name}</span>
//                       </div>
//                       <span className="text-sm font-medium text-gray-900">{item.calls}</span>
//                     </div>
